...
1. copy this repository and rename it to your project name or use `gonew gitdev.devops.krungthai.com/starwolf/backend/template gitdev.devops.krungthai.com/your/service/module/xxxx.git`
